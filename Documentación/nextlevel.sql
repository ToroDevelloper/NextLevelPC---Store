...
-- Procesadores
('AMD Ryzen 9 7950X', 'Procesador de alto rendimiento 16 núcleos', 'Procesador AMD Ryzen serie 7000 con arquitectura Zen 4, ideal para gaming y creación de contenido profesional.', 'Núcleos: 16, Hilos: 32, Frecuencia Base: 4.5GHz, Frecuencia Turbo: 5.7GHz, Socket: AM5, TDP: 170W', 1, 599.99, 15, 1),
('Intel Core i9-13900K', 'Procesador Intel de 13va generación', 'CPU Intel Raptor Lake con 24 núcleos, perfecto para multitarea extrema y gaming de alta gama.', 'Núcleos: 24 (8P+16E), Hilos: 32, Frecuencia: hasta 5.8GHz, Socket: LGA1700, TDP: 125W', 1, 589.99, 12, 1),
('AMD Ryzen 7 7700X', 'Procesador gaming 8 núcleos', 'Excelente rendimiento para juegos y aplicaciones exigentes con tecnología AMD 3D V-Cache.', 'Núcleos: 8, Hilos: 16, Frecuencia: 4.5-5.4GHz, Socket: AM5, TDP: 105W', 1, 359.99, 25, 1),
('Intel Core i5-13600K', 'Procesador mid-range potente', 'Ideal para gaming competitivo y tareas productivas con excelente relación precio-rendimiento.', 'Núcleos: 14 (6P+8E), Hilos: 20, Frecuencia: hasta 5.1GHz, Socket: LGA1700, TDP: 125W', 1, 319.99, 30, 1),

-- Tarjetas Gráficas
('NVIDIA RTX 4090', 'GPU tope de gama 4K gaming', 'La tarjeta gráfica más potente para gaming 4K, ray tracing y creación de contenido profesional.', 'Memoria: 24GB GDDR6X, CUDA Cores: 16384, Boost Clock: 2.52GHz, TDP: 450W', 2, 1599.99, 8, 1),
('AMD Radeon RX 7900 XTX', 'GPU AMD flagship', 'Rendimiento excepcional en 4K con tecnología RDNA 3 y 24GB de memoria.', 'Memoria: 24GB GDDR6, Stream Processors: 6144, Boost: 2.5GHz, TDP: 355W', 2, 999.99, 10, 1),
('NVIDIA RTX 4070 Ti', 'GPU gaming 1440p/4K', 'Perfecta para gaming en alta resolución con ray tracing y DLSS 3.', 'Memoria: 12GB GDDR6X, CUDA Cores: 7680, Boost: 2.61GHz, TDP: 285W', 2, 799.99, 18, 1),
('AMD Radeon RX 7800 XT', 'GPU 1440p gaming', 'Excelente opción para gaming en 1440p con gran valor y rendimiento.', 'Memoria: 16GB GDDR6, Stream Processors: 3840, Boost: 2.43GHz, TDP: 263W', 2, 549.99, 22, 1),

-- Memorias RAM
('Corsair Vengeance DDR5 32GB', 'RAM DDR5 6000MHz', 'Kit de memoria de alta velocidad para plataformas AMD e Intel más recientes.', 'Capacidad: 32GB (2x16GB), Velocidad: 6000MHz, Latencia: CL36, RGB: No', 3, 149.99, 40, 1),
('G.Skill Trident Z5 RGB 32GB', 'RAM RGB DDR5 Premium', 'Memoria DDR5 con iluminación RGB personalizable y rendimiento extremo.', 'Capacidad: 32GB (2x16GB), Velocidad: 6400MHz, Latencia: CL32, RGB: Sí', 3, 189.99, 35, 1),
('Kingston Fury Beast 16GB DDR4', 'RAM DDR4 gaming', 'Memoria confiable para builds DDR4 con excelente compatibilidad.', 'Capacidad: 16GB (2x8GB), Velocidad: 3200MHz, Latencia: CL16, RGB: No', 3, 59.99, 60, 1),
('Corsair Dominator Platinum RGB 64GB', 'RAM enthusiast DDR5', 'Kit premium de 64GB para workstations y gaming extremo.', 'Capacidad: 64GB (2x32GB), Velocidad: 5600MHz, Latencia: CL36, RGB: Sí', 3, 299.99, 15, 1),

-- Almacenamiento
('Samsung 990 Pro 2TB', 'SSD NVMe Gen4 ultra rápido', 'SSD PCIe 4.0 con velocidades de lectura hasta 7,450 MB/s.', 'Capacidad: 2TB, Interfaz: PCIe 4.0 x4, Lectura: 7450MB/s, Escritura: 6900MB/s', 4, 189.99, 45, 1),
('WD Black SN850X 1TB', 'SSD gaming Gen4', 'Optimizado para gaming con tiempos de carga ultra rápidos.', 'Capacidad: 1TB, Interfaz: PCIe 4.0 x4, Lectura: 7300MB/s, Escritura: 6300MB/s', 4, 119.99, 50, 1),
('Crucial P3 Plus 4TB', 'SSD gran capacidad', 'Almacenamiento masivo con excelente rendimiento PCIe Gen4.', 'Capacidad: 4TB, Interfaz: PCIe 4.0 x4, Lectura: 5000MB/s, Escritura: 4200MB/s', 4, 299.99, 25, 1),
('Seagate FireCuda 530 2TB', 'SSD Pro Gen4', 'SSD de alto rendimiento con disipador para uso intensivo.', 'Capacidad: 2TB, Interfaz: PCIe 4.0 x4, Lectura: 7300MB/s, Escritura: 6900MB/s', 4, 249.99, 30, 1),

-- Placas Madre
('ASUS ROG Crosshair X670E Hero', 'Motherboard AMD AM5 premium', 'Placa madre tope de gama para Ryzen 7000 con todas las características.', 'Socket: AM5, Chipset: X670E, RAM: DDR5, PCIe 5.0, WiFi 6E, ATX', 5, 699.99, 12, 1),
('MSI MPG Z790 Carbon WiFi', 'Motherboard Intel Z790', 'Placa robusta para procesadores Intel 13va gen con conectividad completa.', 'Socket: LGA1700, Chipset: Z790, RAM: DDR5, PCIe 5.0, WiFi 6E, ATX', 5, 449.99, 18, 1),
('Gigabyte B650 Aorus Elite AX', 'Motherboard AMD precio-valor', 'Excelente opción mid-range para Ryzen 7000 con WiFi integrado.', 'Socket: AM5, Chipset: B650, RAM: DDR5, PCIe 4.0, WiFi 6, ATX', 5, 229.99, 28, 1),
('ASRock B760M Pro RS', 'Motherboard Intel Micro-ATX', 'Placa compacta para builds Intel de 13va generación.', 'Socket: LGA1700, Chipset: B760, RAM: DDR4/DDR5, PCIe 4.0, Micro-ATX', 5, 159.99, 35, 1),

-- Fuentes de Poder
('Corsair RM1000x 1000W', 'PSU modular 80+ Gold', 'Fuente totalmente modular con certificación 80 Plus Gold.', 'Potencia: 1000W, Certificación: 80+ Gold, Modular: Full, Garantía: 10 años', 6, 169.99, 25, 1),
('EVGA SuperNOVA 850 G6', 'PSU 850W eficiente', 'Fuente de alta eficiencia con cables completamente modulares.', 'Potencia: 850W, Certificación: 80+ Gold, Modular: Full, Garantía: 10 años', 6, 139.99, 30, 1),
('Seasonic Focus GX-750', 'PSU 750W confiable', 'Fuente de calidad premium con excelente regulación de voltaje.', 'Potencia: 750W, Certificación: 80+ Gold, Modular: Full, Garantía: 10 años', 6, 119.99, 40, 1),
('be quiet! Straight Power 11 650W', 'PSU silenciosa 650W', 'Fuente ultra silenciosa con componentes de primera calidad.', 'Potencia: 650W, Certificación: 80+ Gold, Modular: Full, Garantía: 5 años', 6, 99.99, 35, 1),

-- Gabinetes
('Lian Li O11 Dynamic EVO', 'Case ATX vidrio templado', 'Gabinete moderno con excelente flujo de aire y espacio para watercooling.', 'Factor: ATX, Paneles: Vidrio templado, Ventiladores: 9x slots, USB: Type-C', 7, 169.99, 20, 1),
('NZXT H7 Flow', 'Case gaming airflow', 'Diseño minimalista con panel mesh para máximo flujo de aire.', 'Factor: ATX, Paneles: Mesh frontal, Ventiladores: 3x incluidos, USB: Type-C', 7, 129.99, 25, 1),
('Corsair 4000D Airflow', 'Case precio-valor', 'Gabinete popular con excelente balance entre precio y características.', 'Factor: ATX, Paneles: Mesh, Ventiladores: 2x incluidos, Cable management', 7, 99.99, 35, 1),
('Fractal Design Meshify 2 Compact', 'Case compacto mesh', 'Gabinete ATX compacto con diseño mesh angular distintivo.', 'Factor: ATX Compact, Paneles: Mesh angular, Ventiladores: 3x slots, Modular', 7, 119.99, 22, 1),

-- Refrigeración
('NZXT Kraken X73', 'AIO 360mm RGB', 'Refrigeración líquida todo-en-uno con pantalla personalizable.', 'Tamaño: 360mm, Ventiladores: 3x120mm, RGB: Sí, Compatibilidad: Universal', 8, 199.99, 18, 1),
('Noctua NH-D15', 'Cooler aire dual-tower', 'Refrigerador por aire de alto rendimiento ultra silencioso.', 'Tipo: Aire, Torres: Dual, Ventiladores: 2x140mm, TDP: 250W+', 8, 109.99, 28, 1),
('Corsair iCUE H150i Elite', 'AIO 360mm premium', 'AIO de alta gama con ventiladores magnéticos ML RGB.', 'Tamaño: 360mm, Ventiladores: 3x120mm ML RGB, Software: iCUE', 8, 189.99, 20, 1),
('be quiet! Dark Rock Pro 4', 'Cooler aire silencioso', 'Rendimiento excepcional con operación ultra silenciosa.', 'Tipo: Aire, Torres: Dual, Ventiladores: 2x120/135mm, TDP: 250W', 8, 89.99, 32, 1),

-- Periféricos
('Logitech G Pro X Superlight', 'Mouse gaming wireless', 'Mouse ultraligero profesional para esports.', 'Peso: 63g, Sensor: HERO 25K, DPI: 25,600, Batería: 70 horas', 9, 149.99, 45, 1),
('Razer BlackWidow V4 Pro', 'Teclado mecánico RGB', 'Teclado gaming full-size con switches mecánicos personalizables.', 'Switches: Green/Yellow/Orange, RGB: Per-key, Media: Dial + Teclas', 9, 229.99, 30, 1),
('SteelSeries Arctis Nova Pro', 'Headset gaming premium', 'Auriculares con audio de alta fidelidad y cancelación de ruido.', 'Drivers: 40mm, Micrófono: Retráctil, Conexión: Wireless/Wired', 9, 349.99, 22, 1),
('HyperX Alloy Origins 65', 'Teclado 65% compacto', 'Teclado mecánico compacto ideal para escritorios pequeños.', 'Formato: 65%, Switches: HyperX Red, RGB: Sí, Cable: Desmontable', 9, 99.99, 40, 1),

-- Monitores
('Samsung Odyssey G9', 'Monitor ultrawide curvo 49"', 'Monitor gaming curvo super ultrawide 5120x1440 240Hz.', 'Tamaño: 49", Resolución: 5120x1440, Refresh: 240Hz, Panel: VA, HDR1000', 10, 1399.99, 8, 1),
('LG 27GP950-B', 'Monitor 4K 144Hz gaming', 'Monitor 4K con alta tasa de refresco para gaming y productividad.', 'Tamaño: 27", Resolución: 3840x2160, Refresh: 144Hz, Panel: Nano IPS', 10, 799.99, 15, 1),
('ASUS ROG Swift PG279QM', 'Monitor 1440p 240Hz', 'Monitor gaming rápido con tecnología Fast IPS.', 'Tamaño: 27", Resolución: 2560x1440, Refresh: 240Hz, Panel: Fast IPS', 10, 699.99, 18, 1),
('Dell S2722DGM', 'Monitor curved gaming', 'Monitor curvo VA gaming con excelente contraste.', 'Tamaño: 27", Resolución: 2560x1440, Refresh: 165Hz, Panel: VA Curved', 10, 299.99, 25, 1);
...
(1, 'https://images.unsplash.com/photo-1555680202-c86f0e12f086?w=800&q=80', 1),
(2, 'https://images.unsplash.com/photo-1591799264318-7e6ef8ddb7ea?w=800&q=80', 1),
(3, 'https://images.unsplash.com/photo-1587202372634-32705e3bf49c?w=800&q=80', 1),
(4, 'https://images.unsplash.com/photo-1597872200969-2b65d56bd16b?w=800&q=80', 1),
(5, 'https://images.unsplash.com/photo-1591799264318-7e6ef8ddb7ea?w=800&q=80', 1),
(6, 'https://images.unsplash.com/photo-1587202372634-32705e3bf49c?w=800&q=80', 1),
...
(1, 1, NULL, 'producto', 'AMD Ryzen 9 7950X', 1, 599.99, 599.99),
(1, 1, NULL, 'producto', 'AMD Ryzen 9 7950X', 1, 599.99, 599.99),
(2, 8, NULL, 'producto', 'AMD Radeon RX 7800 XT', 1, 549.99, 549.99),
(3, NULL, 1, 'servicio', 'Instalación de Windows/Linux', 1, 299.00, 299.00),
(4, 5, NULL, 'producto', 'NVIDIA RTX 4090', 1, 1599.99, 1599.99),
(4, 6, NULL, 'producto', 'AMD Radeon RX 7900 XTX', 1, 999.99, 999.99),
(5, NULL, 7, 'servicio', 'Ensamblaje de PC Gaming/Workstation', 1, 1499.00, 1499.00),
(6, 38, NULL, 'producto', 'LG 27GP950-B', 1, 799.99, 799.99);
